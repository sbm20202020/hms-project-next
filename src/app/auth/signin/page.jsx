...
const LoginPage = ({searchParams}) => {
  ...
  return (
      <div className="relative min-h-screen bg-gradient-to-br from-teal-50 to-white flex">
        ...
        <div className="flex-1 flex items-start justify-center px-3 sm:px-5 lg:px-7 py-6 lg:py-8">
          <div className="w-full max-w-full sm:max-w-lg md:max-w-xl lg:max-w-2xl space-y-3 sm:space-y-4">
            {/* Logo et titre */}
            ...
            {/* Formulaire */}
            <form className="mt-2 sm:mt-3 space-y-2.5 sm:space-y-3" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      aria-describedby={fieldErrors.password ? 'password-error' : (password && password.length > 0 ? 'password-help' : undefined)}
                      required
                      value={password}
                      onChange={(e) => {
                        const v = e.target.value
            ...
            <div className="mt-3.5 sm:mt-4 p-3 sm:p-4 bg-gray-50 rounded-lg">
